...
- ✅ Кнопки +/- (изменения количества) работают корректно
- ✅ При количестве товара 1шт, кнопка уменьшения заменяется на удаление
- ✅ Кнопка удаления работает корректно
- ✅ При обновлении страницы все состояния товаров в корзине сохраняются (количество и выбор)
- ✅ Кнопка удаления выбранного работает корректно
- ✅ Цена и выгода отображается корректно
